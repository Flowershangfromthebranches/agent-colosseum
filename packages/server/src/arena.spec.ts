...
describe('presence timers', () => {
  it('does not forfeit at 89s and forfeits after 90s', async () => {
    ...
    book.disconnect('d', 0)
    expect(book.offlineSince('d', 89_000)).toBe(89_000)
    expect(book.offlineSince('d', 89_000)).toBeLessThanOrEqual(90_000)
    expect(book.offlineSince('d', 90_001)).toBeGreaterThan(90_000)
